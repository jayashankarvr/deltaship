...
**Document:** Deltaship Project Governance
...
This document describes the governance model for Deltaship (Version-Aware Binary Differential Update System). Our goal is to maintain a transparent, inclusive, and efficient decision-making process that ensures the project's long-term sustainability while encouraging community participation.
...
Anyone using Deltaship in their projects.
...
1. **Report**: Via security@deltaship.example.com (private)
...
1. Report to conduct@deltaship.example.com
...
**security@deltaship.example.com**: Security vulnerability reports
- Expected response: 48 hours

**conduct@deltaship.example.com**: Code of Conduct issues
- Expected response: 48 hours

**maintainers@deltaship.example.com**: Maintainer coordination
...
- **Private concerns**: maintainers@deltaship.example.com
