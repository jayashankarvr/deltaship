# Version-Aware Binary Differential Update System (Deltaship)
...
3. Review the [updater sidecar contract](integration/INTEGRATION_GUIDE.md#5-the-deltaship-updater-sidecar-contract) and [per-platform notes](integration/INTEGRATION_GUIDE.md#7-per-platform-integration-notes)
