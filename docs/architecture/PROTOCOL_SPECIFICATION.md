...
**Document:** Communication protocols for VBDP components
...
This document specifies the communication protocols used between VBDP components: Publisher Toolkit, Update Server, and Client Patcher.
...
ETag: "abc123"
X-VBDP-Hash: blake3:abc123...
X-VBDP-From-Version: 1.0.0
X-VBDP-To-Version: 1.1.0
...
Host: updates.example.com
Content-Type: application/json
X-VBDP-API-Key: vbdp_publisher_abc123...
X-VBDP-Timestamp: 1704628496
X-VBDP-Signature: hmac_sha256(secret, "timestamp:body")
...
**Structure:**
```
[VBDP Header]  # 64 bytes
[bsdiff data]  # Variable length
```

**VBDP Header (64 bytes):**
```
Bytes 0-3:   Magic number: "VBDP" (0x56 0x42 0x44 0x50)
...
**Header Format:**
```
X-VBDP-API-Key: vbdp_publisher_{64_hex_chars}
X-VBDP-Timestamp: {unix_timestamp}
X-VBDP-Signature: {hmac_sha256_signature}
```
...
X-VBDP-Event: update.success
X-VBDP-Signature: hmac_sha256(webhook_secret, body)
...
**Client sends:**
```
X-VBDP-Client-Version: 1.0.0
Accept: application/vnd.vbdp.v1+json
```

**Server responds:**
```
X-VBDP-Server-Version: 1.0.0
Content-Type: application/vnd.vbdp.v1+json
```

**If client version too old:**
```
HTTP/1.1 426 Upgrade Required
X-VBDP-Minimum-Client-Version: 1.2.0

{
  "error": "client_too_old",
  "message": "Please upgrade to client version 1.2.0 or higher",
  "upgrade_url": "https://vbdp.io/download"
}
```
