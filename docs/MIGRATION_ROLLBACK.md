...
This document describes how to rollback database migrations in VBDP when issues occur.
...
⚠️ **Current Status**: VBDP v0.1.0 does not support automated rollbacks. All rollbacks must be performed manually.
...
systemctl stop vbdp-client  # or your service manager
...
systemctl stop vbdp-publisher  # or your service manager
...
# 6. Start the application
systemctl start vbdp-publisher
```
