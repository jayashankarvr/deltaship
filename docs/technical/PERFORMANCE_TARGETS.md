...
**Document:** Measurable performance goals and benchmarks for VBDP
...
This document defines specific, measurable performance targets for the VBDP system. All targets must be met for v1.0 release.
