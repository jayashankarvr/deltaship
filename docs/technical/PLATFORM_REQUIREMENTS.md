...
**Document:** System requirements for running Deltaship on different platforms
...
This document specifies the minimum and recommended system requirements for running Deltaship components (Publisher Toolkit, Update Server, Client Patcher) on various platforms.
...
**Images:**
- `deltaship/server:latest` (API server)
- `deltaship/publisher:latest` (Publisher toolkit)
...
**Helm Chart:** `jayashankarvr/deltaship-server` (version 1.0+)
