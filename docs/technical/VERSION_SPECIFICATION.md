...
Deltaship is a **Version-Aware** Binary Differential Update System. The core functionality depends on correctly comparing and ordering versions to:
...
This document specifies how Deltaship compares versions across different versioning schemes.
...
Deltaship supports four primary versioning schemes:
...
deltaship-register --version "$BUILD_NUMBER" --binary ./myapp
```
...
**Deltaship stance:** **Prevent** by default, configurable override for advanced use cases
