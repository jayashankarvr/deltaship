...
Currently, Deltaship is in the design and documentation phase. Once implementation begins, this section will list which versions receive security updates.
...
**Email:** security@deltaship.example.com (PGP key available below)
...
- **GitHub Security Advisories:** https://github.com/jayashankarvr/deltaship/security/advisories <!-- TODO: Update URL when repository is published -->
<!-- TODO: Before public release, update to actual mailing list address -->
- **Mailing List:** deltaship-security-announce@deltaship.example.com (subscribe to receive notifications)
- **Website:** https://deltaship.io/security
...
- **Scope:** Deltaship Server, Client Patcher, Publisher Toolkit, Official SDKs
...
**Signing Keys:**
- Generate strong Ed25519 keys (use `deltaship-init` or `ssh-keygen -t ed25519`)
...
**Infrastructure:**
- Keep software up-to-date (OS, dependencies, Deltaship)
...
- alert: SuspiciousSignatureFailures
  expr: rate(deltaship_signature_verification_failures[5m]) > 10
  annotations:
...
**Monitoring:**
- Check logs for suspicious activity (`/var/log/deltaship/`)
...
1. **Never run Deltaship client as root** - run as unprivileged user
...
**Code References:**
- `crates/deltaship-client/src/patcher.rs` - validate_install_path() function documentation
- `crates/deltaship-client/src/commands/add.rs` - Binary registration validation
...
3. **Notification:**
   <!-- TODO: Before public release, update to actual mailing list address -->
   - Email to deltaship-security-announce@deltaship.example.com
   - GitHub notification
...
- https://deltaship.io/security/hall-of-fame
...
<!-- TODO: Before public release, update to actual security contact email -->
**Primary Contact:** security@deltaship.example.com

**PGP Key:** (Will be provided when implementation starts)
```
Fingerprint: [TO BE ADDED]
Key ID: [TO BE ADDED]
Download: https://deltaship.io/security/pgp-key.asc
```
...
- Email: security-urgent@deltaship.example.com
...
- Don't harm Deltaship or its users
...
Deltaship security practices are designed to comply with:
...
<!-- TODO: Before public release, update to actual security contact email -->
- Email: security@deltaship.example.com
- Open a GitHub Discussion (for non-sensitive questions)
- See our [FAQ](https://deltaship.io/security/faq) (when available)
...
**Thank you for helping keep Deltaship secure!** 🔒
