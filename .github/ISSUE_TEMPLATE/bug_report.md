---
name: Bug Report
about: Report a bug or unexpected behavior in VBDP
title: '[BUG] '
...
```bash
vbdp-client update --binary myapp
```
...
- [ ] Blocks critical functionality (cannot use VBDP)
...
- [ ] This is not a security vulnerability (if security-related, email security@vbdp.example.com instead)
