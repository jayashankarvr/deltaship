...
///
/// 1 GiB matches `deltaship_diff::MAX_DECOMPRESSED_SIZE`: large enough for any
...
mod tests {
    ...
    fn test_apply_patch_files_roundtrip() {
        ...
        let old_path = temp_dir.join("deltaship_test_apply_old.bin");
        let new_path = temp_dir.join("deltaship_test_apply_new.bin");
        let diff_path = temp_dir.join("deltaship_test_apply_diff.bin");
        let recovered_path = temp_dir.join("deltaship_test_apply_recovered.bin");
    ...
    fn test_apply_patch_large_files() {
        let temp_dir = std::env::temp_dir();
        let old_path = temp_dir.join("deltaship_test_large_apply_old.bin");
        let new_path = temp_dir.join("deltaship_test_large_apply_new.bin");
        let diff_path = temp_dir.join("deltaship_test_large_apply_diff.bin");
        let recovered_path = temp_dir.join("deltaship_test_large_apply_recovered.bin");
