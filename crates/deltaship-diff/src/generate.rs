...
mod tests {
    ...
    fn test_generate_diff_files() {
        ...
        let old_path = temp_dir.join("deltaship_test_old.bin");
        let new_path = temp_dir.join("deltaship_test_new.bin");
        let diff_path = temp_dir.join("deltaship_test_diff.bin");
    ...
    fn test_generate_diff_large_files() {
        let temp_dir = std::env::temp_dir();
        let old_path = temp_dir.join("deltaship_test_large_old.bin");
        let new_path = temp_dir.join("deltaship_test_large_new.bin");
        let diff_path = temp_dir.join("deltaship_test_large_diff.bin");
    ...
    fn test_diff_stats_compression_ratio() {
        let temp_dir = std::env::temp_dir();
        let old_path = temp_dir.join("deltaship_test_ratio_old.bin");
        let new_path = temp_dir.join("deltaship_test_ratio_new.bin");
        let diff_path = temp_dir.join("deltaship_test_ratio_diff.bin");
