//! Key management operations for Deltaship signing keys.
//!
...
const SIGNING_KEY_HEADER: &str = "-----BEGIN DELTASHIP SIGNING KEY-----";
const SIGNING_KEY_FOOTER: &str = "-----END DELTASHIP SIGNING KEY-----";
const ENCRYPTED_SIGNING_KEY_HEADER: &str = "-----BEGIN DELTASHIP ENCRYPTED SIGNING KEY-----";
const ENCRYPTED_SIGNING_KEY_FOOTER: &str = "-----END DELTASHIP ENCRYPTED SIGNING KEY-----";
const VERIFYING_KEY_HEADER: &str = "-----BEGIN DELTASHIP VERIFYING KEY-----";
const VERIFYING_KEY_FOOTER: &str = "-----END DELTASHIP VERIFYING KEY-----";
...
mod tests {
    ...
    fn temp_file(name: &str) -> PathBuf {
        ...
        temp_dir.join(format!("deltaship_test_{}", name))
    }
