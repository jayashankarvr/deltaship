...
/// Database errors for VBDP operations.
#[derive(Debug, Error)]
pub enum DbError {
...
impl From<sqlx::Error> for DbError {
    fn from(err: sqlx::Error) -> Self {
        ...
        //
        // 1. VBDP exclusively uses SQLite for local storage (both publisher and client)
        ...
        //
        // If VBDP ever needs to support other databases (PostgreSQL, MySQL, etc.),
